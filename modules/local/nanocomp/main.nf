process NANOCOMP {
    ...
    tuple val(meta), path("*.png"), emit: figures, optional: true
    tuple val(meta), path("*NanoComp_lengths_violin.html"), emit: lengths_violin_html, optional: true
    tuple val(meta), path("*NanoComp_log_length_violin.html"), emit: log_length_violin_html, optional: true
    tuple val(meta), path("*NanoComp_lengths_ridge.html"), emit: lengths_ridge_html, optional: true
    tuple val(meta), path("*NanoComp_log_length_ridge.html"), emit: log_length_ridge_html, optional: true
    tuple val(meta), path("*NanoComp_lengths_box.html"), emit: lengths_box_html, optional: true
    tuple val(meta), path("*NanoComp_log_length_box.html"), emit: log_length_box_html, optional: true
